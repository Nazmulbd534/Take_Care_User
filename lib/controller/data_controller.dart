...
class DataController extends GetxController {
  ...
  Future<void> sendNotification(String receiverId) async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('users')
        .where('phone', isEqualTo: receiverId)
        .get();
    ...
    final data = <String, dynamic>{
      ...
      'status': 'done',
      'message':
          '${DataControllers.to.userLoginResponse.value.data!.user!.fullName} sent you a request',
      'sender':
      ...
      http.Response response =
          await http.post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
              headers: <String, String>{
                ...
                'Authorization':
                    'key=AAAANQH8hdE:APA91bGQJCiSJClNaFXsgIGNbI3wNM8chjmPXNM5Is0hj_WHlgiyU663TvmpPP4YOwOsVnEnuinjYBY4GZdfNz5nO1w2jSAA5RlgdnkNGPJAf7ZEM_LS_u-pLe5tWntbRffqxmvcoxLB'
              },
  ...
  Future<void> confirmOrder(
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'invoiceNumber':
            DataControllers.to.appResponse.value.data!.invoiceNumber,
      }).whenComplete(() async {
        QuerySnapshot snapshot = await FirebaseFirestore.instance
            .collection('users')
            .where('phone', isEqualTo: receiverId)
        ...
        final data = <String, dynamic>{
          ...
          'status': 'done',
          'message':
              '${DataControllers.to.userLoginResponse.value.data!.user!.fullName} confirmed your request',
          'sender':
              '${DataControllers.to.userLoginResponse.value.data!.user!.phone}',
          'receiver': receiverId,
        };
