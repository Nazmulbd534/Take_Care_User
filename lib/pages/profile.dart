      ...
      builder: (language) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text(language.profile.string),
            actions: [],
          ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                    onPressed: () {},
                                    child: Text(language.edit.string))
                              ],
                            ),
                          ),
                          Padding(
