...
class _ForgotPassPageState extends State<ForgotPassPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      body: GetBuilder<LanguageController>(builder: (lang) {
                  ...
                  Padding(
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                              text: '${lang.forgetPassText1.string}\n',
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: dynamicSize(.09))),
                          TextSpan(
                            text: lang.forgetPassText2.string,
                            style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        controller:
                            DataControllers.to.forgetPasswordMobile.value,
                        decoration: InputDecoration(
                            border: OutlineInputBorder(),
                            labelText: lang.enterMobile.string,
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (newPassword.text.isEmpty ||
                            ...
                            showToast(lang.plsEnterMore5.string);
                          } else {
                            print("number : " +
                                DataControllers
                                    .to.forgetPasswordMobile.value.text
                                    .toString());
                            final signature =
                                await SmsAutoFill().getAppSignature;

                            await DataControllers.to.forgetPassMobileValidation(
                                DataControllers
                                    .to.forgetPasswordMobile.value.text
                                    .toString(),
                                signature);

                            if (DataControllers.to.forgetPassMobileOtpResponse
                                .value.success!) {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) => const RecoverPassPage()));
                            } else {
                              showToast(DataControllers.to
                                  .forgetPassMobileOtpResponse.value.message!);
                            }
                          }
                        },
                        child: Row(
