      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: dynamicSize(0.05), fontWeight: FontWeight.bold),
          ),
          SizedBox(
            height: dynamicSize(0.6),
          ),
          Text(
            "Thank You for Enjoying Our Service(s)",
            style: TextStyle(fontSize: dynamicSize(0.035)),
          ),
          SizedBox(
          ...
          TextButton(
            ...
            child: Text(
              "Go to Home",
              style:
                  TextStyle(fontSize: dynamicSize(0.05), color: Colors.green),
            ),
          ),
          SizedBox(
            height: dynamicSize(0.04),
          ...
          TextButton(
            ...
            child: Text(
              "Give a Feedback",
              style: TextStyle(fontSize: dynamicSize(0.05), color: Colors.blue),
            ),
          ),
        ],
      ),
