                              ...
                              child: Column(
                                children: [
                                          ...
                                          InkWell(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    "${DataControllers.to.getAvailableProviderList.value.data!.provider_data!.first.fullName}",
                                                    style: TextStyle(
                                                        fontSize:
                                                            dynamicSize(0.05),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        'Monday, 1st Jan, 2021 - Monday, 1st Jan, 2021',
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [Text('Base Price'), Text('1,300/-')],
              ),
            ),
            Container(
              padding: EdgeInsets.all(13),
            ...
            if (!paid) Text('Instead of Cash Payment , you can pay online.'),
            if (paid)
              Text(
                '* Online Payment.\n* Received by TakeCare Health Services Ltd.',
